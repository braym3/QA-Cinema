          ...
          <Row>
            ...
            <Col xs={9}>
              <h4 className='classification-name'>
                <b>{classification.name}</b> - <i>{classification.fullName}</i>
              </h4>
            </Col>
          </Row>
          <Row>
            <p style={{ marginTop: "5%" }}>
              <b>{classification.description}</b>
            </p>
    ...
    <>
      <div className='classifications-content'>
        <Row className='classifications-header'>
          <h1 style={{ marginBottom: "3%" }} id='classifications-title'>
            Film Classifications
          </h1>
          <p>
            Classification is the process of giving age ratings and content advice to films and other audiovisual
            content to help children and families choose what’s right for them and avoid what’s not.
          </p>
